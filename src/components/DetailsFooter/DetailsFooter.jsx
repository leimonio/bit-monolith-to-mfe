    ...
    <div id="howtowatch">
      ...
      <div className="blackDiv">
        ...
        <div id="about">
          <div id="about1">
            <div id="info">
              <h3 className="ab" id="ab1">
                Pretzel and the Puppies{' '}
              </h3>
              <p className="ab" id="ab2">
                KIDS & FAMILY{' '}
              </p>
            </div>
          </div>
          <div id="about2">
            <div className="abc">
              <h3 className="Z">Information</h3>
              <p className="A">Genre</p>
              <p className="B">Thriller</p>
              <p className="C">Released</p>
              <p className="D">2022</p>
              <p className="E">Rated</p>
              <p className="F">TV-MA</p>
              <p className="G">Region of Origin</p>
              <p className="H">Original Audio</p>
              <p className="I">United States</p>
              <p className="J">English</p>
            </div>
            <div className="abc">
              <h3 className="Z">Languages</h3>
              <p className="A">Audio</p>
              <p className="B">
                English (AD, AAC, Dolby Atoms, Doly 5.1),and 9 more...
              </p>
              <p className="C">Subtitles</p>
              <p className="D">English(CC,SDH), and 40 more</p>
              <a href="" id="anchor">
                See All
              </a>
            </div>
            <div className="abc">
              <h3 className="Z">Accessibility</h3>
              <svg
          ...
          <div className="main-footer">
            <div className="main-footer_info">
              ...
              <div className="main-footer_info-nav">
                ...
                <div className="footer-info_items">Video+ & Privacy</div>
